...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Creating unique_together for [short] on Language.
        db.create_unique('book_language', ['short'])
        
    
    
    def backwards(self, orm):
        
        # Deleting unique_together for [short] on Language.
        db.delete_unique('book_language', ['short'])
