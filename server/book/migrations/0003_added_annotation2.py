...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Annotation2'
        db.create_table('book_annotation2', (
            ('id', orm['book.annotation2:id']),
            ('name', orm['book.annotation2:name']),
            ('book', orm['book.annotation2:book']),
        ))
        db.send_create_signal('book', ['Annotation2'])
        
    
    
    def backwards(self, orm):
        
        # Deleting model 'Annotation2'
        db.delete_table('book_annotation2')
