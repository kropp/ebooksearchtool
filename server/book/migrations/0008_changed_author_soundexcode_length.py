...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Author.name_soundex'
        # (to signature: django.db.models.fields.CharField(max_length=255))
        db.alter_column('book_author', 'name_soundex', orm['book.author:name_soundex'])
    ...
    models = {
        ...
        'book.author': {
            ...
            'name_soundex': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
